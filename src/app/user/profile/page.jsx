            ...
            <section className='px-1 sm:px-4 md:px-8 lg:px-20'>
                <div className=' grid grid-flow-row md:grid-cols-2 py-4 gap-6'>
                    ...
                    <div className=' grid grid-flow-row sm:grid-flow-col sm:grid-col-2 sm:grid-rows-2 gap-6 '>
                        ...
                        <Link href={"/user/profile/delete"}><div className='bg-red-300 w-full h-20 sm:h-full text-center content-center text-2xl font-serif font-bold rounded-lg shadow-slate-400 shadow-lg hover:scale-95 sm:hover:scale-110 transition-all ease-in-out duration-500 p-2'>Delete Profile</div></Link>
                    </div>
                </div>
                <div className='my-8'>
